...
export default function Register() {
    return (
        <div>
            <NavBar />
            <div className="min-h-screen bg-gray-100 text-gray-900 dark:bg-[hsl(240,_10%,_3.9%)] flex justify-center items-center">
                <div className="max-w-screen-xl h-fit m-0 sm:m-10 dark:bg-zinc-700 bg-white shadow sm:rounded-lg flex justify-between flex-1">
                        ...
                        <div className="mt-4 flex flex-col items-center">
                            ...
                            <div className="w-full flex-1 mt-8">
                                ...
                                <div className="my-12 border-b text-center">
                                    <div
                                        className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white dark:bg-zinc-700 dark:text-white transform translate-y-1/2">
